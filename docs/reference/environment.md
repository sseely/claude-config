...
Lookup material for `rules/environment.md`. The binding rule — naming
convention, validate-at-startup, never log secret values — lives in that
rule file and is always resident. This is the full detail: examples and
