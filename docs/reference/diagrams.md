...
Lookup material for `rules/diagrams.md`. The binding rule — PlantUML is the
default for every generated diagram, with two stated exceptions — lives in
that rule file and is always resident. This is the full rubric,
tie-breakers, and quality bar.
