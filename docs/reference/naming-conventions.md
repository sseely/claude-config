...
Lookup material for `rules/naming-conventions.md`. The binding rule —
folder layout, symbol-case rules, DB naming patterns — lives in that rule
file and is always resident. This is the full detail: file naming and
test colocation.
